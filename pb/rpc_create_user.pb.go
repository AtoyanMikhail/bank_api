...
const file_rpc_create_user_proto_rawDesc = "" +
	...
	"user.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xe9\x02\n" +
	"\x11CreateUserRequest\x12{\n" +
	"\busername\x18\x01 \x01(\tB_\x92AX23Unique username for the account (alphanumeric only)J\n" +
	"\"john_doe\"x2\x80\x01\x01\x8a\x01\x0f^[a-zA-Z0-9_]+$\xe2A\x01\x02R\busername\x12B\n" +
	"\tfull_name\x18\x02 \x01(\tB%\x92A\x1e2\x10User's full nameJ\n" +
	"\"John Doe\"\xe2A\x01\x02R\bfullName\x12J\n" +
	"\x05email\x18\x03 \x01(\tB4\x92A-2\x13Valid email addressJ\x16\"john.doe@example.com\"\xe2A\x01\x02R\x05email\x12G\n" +
	"\bpassword\x18\x04 \x01(\tB+\x92A$2\x1fPassword (minimum 6 characters)\x80\x01\x06\xe2A\x01\x02R\bpassword\"Q\n" +
	"\x12CreateUserResponse\x12;\n" +
	"\x04user\x18\x01 \x01(\v2\b.pb.UserB\x1d\x92A\x1a2\x18Created user informationR\x04userB&Z$github.com/AtoyanMikhail/bank_api/pbb\x06proto3"
