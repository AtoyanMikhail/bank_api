...
const file_rpc_create_transfer_proto_rawDesc = "" +
	"\n" +
	"\x19rpc_create_transfer.proto\x12\x02pb\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\raccount.proto\"\x97\x01\n" +
	...
	"\bcurrency\x18\x04 \x01(\tR\bcurrency\"\xb9\x01\n" +
	"\bTransfer\x12\x0e\n" +
	...
	"\bto_entry\x18\x05 \x01(\v2\t.pb.EntryR\atoEntryB&Z$github.com/AtoyanMikhail/bank_api/pbb\x06proto3"
...
var file_rpc_create_transfer_proto_depIdxs = []int32{
	...
	1, // 2: pb.CreateTransferResponse.transfer:type_name -> pb.Transfer
	...
	2, // 5: pb.CreateTransferResponse.from_entry:type_name -> pb.Entry
	2, // 6: pb.CreateTransferResponse.to_entry:type_name -> pb.Entry
