...
func (x *CreateAccountResponse) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
const file_rpc_create_account_proto_rawDesc = "" +
	"\n" +
	"\x18rpc_create_account.proto\x12\x02pb\x1a\x1fgoogle/protobuf/timestamp.proto\"2\n" +
	"\x14CreateAccountRequest\x12\x1a\n" +
	"\bcurrency\x18\x01 \x01(\tR\bcurrency\"\xae\x01\n" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAtB&Z$github.com/AtoyanMikhail/bank_api/pbb\x06proto3"
...
var file_rpc_create_account_proto_depIdxs = []int32{
	2, // 0: pb.CreateAccountResponse.created_at:type_name -> google.protobuf.Timestamp
