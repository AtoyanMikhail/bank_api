...
import (
	...
	"github.com/AtoyanMikhai/bank_api/api"
	db "github.com/AtoyanMikhai/bank_api/db/sqlc"
	"github.com/AtoyanMikhai/bank_api/gapi"
	"github.com/AtoyanMikhai/bank_api/mail"
...
func runGatewayServer(
	...
	waitGroup.Go(func() error {
		...
		if err != nil {
			...
			log.Fatal().Err(err).Msg("HTTP Gateway server failed to start")
			return err
		}
		return nil
	})
	...
	waitGroup.Go(func() error {
		<-ctx.Done()
		log.Info().Msg("shutting down HTTP gateway server gracefully")
